...
#
# INSERT INTO albums (artist, name, release_date, sales, genre)
# VALUES ('AC/DC', 'Back in Black', 1980, 30.1, 'Country rock');
#
# INSERT INTO albums (artist, name, release_date, sales, genre)
# VALUES ('Eagles', 'Hotel California', 1976, 31.8, 'Soft rock');
#
# INSERT INTO albums (artist, name, release_date, sales, genre)
# VALUES ('Shania Twain', 'Come On Over', 1997, 30.4, 'Country');

INSERT INTO albums (artist, name, release_date, sales, genre)
VALUES ('Led Zeppelin', 'Led Zeppelin IV', 1971, 30.4, 'Hard rock'),
 ('Michael Jackson', 'Thriller', 1982, 50.2, 'Pop'),
 ('AC/DC', 'Back in Black', 1980, 30.1, 'Country rock'),
 ...
 ('Shania Twain', 'Come On Over', 1997, 30.4, 'Country'),
       ...
       ('Adele', '21', 1996, 27.1, 'Pop'),
       ('The Beatles', '1', 2000, 23.2, 'Rock'),
       ('Metallica','Metallica', 2000, 23.2, 'Heavy metal'),
